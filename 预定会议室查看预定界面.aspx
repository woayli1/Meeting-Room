<%@ Page Language="C#" AutoEventWireup="true" CodeFile="预定会议室查看预定界面.aspx.cs" Inherits="预定会议室查看预定界面" %>
...
<body>
    ...
    <p class="auto-style8">
        ...
        选择预定会议室预定，<asp:Label ID="Label1" runat="server" BackColor="#00CC00" BorderColor="#00CC00" ForeColor="#00CC00" Text="绿色"></asp:Label>
            绿色表示可以预定，<asp:Label ID="Label2" runat="server" BackColor="#CC0000" BorderColor="#CC0000" ForeColor="#CC0000" Text="红色"></asp:Label>
            红色表示已被预定</p>
    <table align:"center" class="auto-style1">
        <tr>
            <td class="auto-style2">预定会议室1</td>
        ...
        <tr>
            <td class="auto-style2">预定会议室2</td>
            <td class="auto-style3">
        ...
        <tr>
            <td class="auto-style2">预定会议室3</td>
            <td class="auto-style3">
        ...
        <tr>
            <td class="auto-style2">预定会议室4</td>
            <td class="auto-style3">
        ...
        <tr>
            <td class="auto-style2">预定会议室5</td>
            <td class="auto-style3">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p>
            <asp:Button ID="Button26" runat="server" Text="返回上一个界面" OnClick="Button26_Click" style="z-index: 1; left: 853px; top: 490px; position: absolute; height: 30px" Width="143px" />
        </p>
    </form>
</body>
</html>
