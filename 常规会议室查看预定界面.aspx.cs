...
public partial class 常规会议室查看预定界面 : System.Web.UI.Page
{
    ...
    public bool yuding(Button btn)
    {
        ...
        int[] date1 = new int[] {date,0,0,0,0};
        int date2 = 0;
        String room_id = null;
        String time = null;
        ...
        Session["time"] = time;
        Session["date"] = Convert.ToInt32(Session["date"].ToString().Trim());
        Session["date1"] = date1;
        Session["room_type"] = "changgui";
        return true;
